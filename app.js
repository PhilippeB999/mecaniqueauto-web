...
const STORAGE_KEY = "mecaquest_state_v1";
...
const ACCESS_CODE = "MECANIQUE-2026-KF43"; // code fourni au centre de formation après achat de la licence
...
const SYNC_KEY = "mecaquest_sync_pending";
